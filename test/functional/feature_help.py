...
"""Verify that starting nexsicoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nexsicoin with -h for help text")
        ...
        self.log.info("Start nexsicoin with -version for version information")
        ...
        self.log.info("Start nexsicoind with -fakearg to make sure it does not start")
