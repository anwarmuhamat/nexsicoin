# Support for Output Descriptors in Nexsicoin Core

Since Nexsicoin Core v0.17, there is support for Output Descriptors. This is a
...
on Nexsicoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Nexsicoin Core wallets, a convenience function `combo` is
