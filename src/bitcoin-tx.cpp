...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nexsicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nexsicoin-tx [options] <hex-tx> [commands]  Update hex-encoded nexsicoin transaction\n" +
            "or:     nexsicoin-tx [options] -create [commands]   Create hex-encoded nexsicoin transaction\n" +
            "\n";
