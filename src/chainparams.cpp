...
{
    const char* pszTimestamp = "DETIK NEWS 14/March/2021 Kemenkes: Belum Ditemukan Varian Corona B117 di DKI Jakarta";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1615721976, 834996, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xfae509624fb49ba1513f6944b889ff1a8cd30fb6fa90c7305a49b9cb89dc9682"));
        assert(genesis.hashMerkleRoot == uint256S("0x381ce1ec66d4435b813d1e9012674b20f8fdcc1e050c32228e989267b9eb7cd9"));
        ...
        // vSeeds.emplace_back("seed-a.nexsicoin.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.nexsicointools.com");
        // vSeeds.emplace_back("dnsseed.nexsicoinpool.org");
...
public:
    CTestNetParams() {
        ...
        // vSeeds.emplace_back("testnet-seed.nexsicointools.com");
        // vSeeds.emplace_back("seed-b.nexsicoin.loshan.co.uk");
